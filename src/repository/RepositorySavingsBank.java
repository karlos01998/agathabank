...
public class RepositorySavingsBank {
    ...
    public static void modelSavingsBankCreateInity() {
        ModelSavingsBank countOne = new ModelSavingsBank(12345678990L, "Maria Eunice", 2000, 5, 6, 654321, 1000000);
        ModelSavingsBank countTwo = new ModelSavingsBank(12345678991L, "Agatha Leal", 2017, 7, 30, 808080, 2000);
